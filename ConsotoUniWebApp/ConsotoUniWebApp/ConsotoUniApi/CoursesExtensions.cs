...
namespace ConsotoUniWebApp
{
    public static partial class CoursesExtensions
    {
        ...
        /// Reference to the ConsotoUniWebApp.ICourses.
        /// </param>
        /// <param name='id'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<ConsotoUniWebApp.Models.Course> result = await operations.DeleteCourseWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<ConsotoUniWebApp.Models.Course> result = await operations.GetCourseWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<ConsotoUniWebApp.Models.Course>> result = await operations.GetCoursesWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<ConsotoUniWebApp.Models.Course> result = await operations.PostCourseWithOperationResponseAsync(course, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
