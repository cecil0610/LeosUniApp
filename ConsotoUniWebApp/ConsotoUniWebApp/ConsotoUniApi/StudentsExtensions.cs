...
namespace ConsotoUniWebApp
{
    public static partial class StudentsExtensions
    {
        ...
        /// Reference to the ConsotoUniWebApp.IStudents.
        /// </param>
        /// <param name='id'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<ConsotoUniWebApp.Models.Student> result = await operations.DeleteStudentWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<ConsotoUniWebApp.Models.Student> result = await operations.GetStudentWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<ConsotoUniWebApp.Models.Student>> result = await operations.GetStudentsWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<ConsotoUniWebApp.Models.Student> result = await operations.PostStudentWithOperationResponseAsync(student, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
